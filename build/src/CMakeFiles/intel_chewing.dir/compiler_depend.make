...
src/libintel_chewing.so: /usr/lib/crti.o \
  /usr/lib/crtn.o \
  /usr/lib/libc.so \
  /usr/lib/libchewing.so \
  /usr/lib/libgcc_s.so \
  ...
  /usr/lib/libFcitx5Config.so.5.1.14 \
  /usr/lib/libFcitx5Core.so.5.1.14 \
  /usr/lib/libFcitx5Utils.so.5.1.14 \
  /usr/lib/libc.so.6 \
